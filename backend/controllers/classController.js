...
exports.createClass = async (req, res) => {
  try {
    ...
    const { name, description, tutorIds, department } = req.body; // Ajout de department
    ...
    const newClass = new Class({
      name,
      description,
      department, // Ajout du department
...
exports.updateClass = async (req, res) => {
  try {
    ...
    if (department) classDoc.department = department; // Ajout de la mise à jour du department
    await classDoc.save();
