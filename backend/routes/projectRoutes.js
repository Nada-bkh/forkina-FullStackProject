...
router.post('/:projectId/create-repository', projectController.createRepository);
...
router.put('/:projectId/assign-classes', projectController.assignClassesToProject);
