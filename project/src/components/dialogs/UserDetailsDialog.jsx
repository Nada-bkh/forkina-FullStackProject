          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <LabelValue
                  label="Role"
                  value={user.userRole}
                  chip={{ color: getRoleColor(user.userRole) }}
              />
              <LabelValue
                  label="Account Status"
                  value={user.accountStatus ? 'Active' : 'Inactive'}
                  chip={{ color: user.accountStatus ? 'success' : 'error' }}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <LabelValue
                  label="Birth Date"
                  value={user.birthDate ? new Date(user.birthDate).toLocaleDateString() : 'Not provided'}
              />
                ...
                <>
                  ...
                  <Grid item xs={12} md={6}>
                    <LabelValue
                        ...
                        value={user.educationLevel || 'BEGINNER'}
                        chip={{
                  ...
                  <Grid item xs={12} md={6}>
                    <LabelValue label="Class" value={user.classe ? user.classe.name : 'Not assigned'} />
                  </Grid>
                </>
            )}
            ...
            <Grid item xs={12} md={6}>
              <LabelValue
                  ...
                  chip={{ color: user.isEmailVerified ? 'success' : 'warning' }}
              />
            </Grid>
          </Grid>
        </DialogContent>
...
UserDetailsDialog.propTypes = {
  ...
  user: PropTypes.shape({
    ...
    classe: PropTypes.any,  // Adjusted to handle populated class object
