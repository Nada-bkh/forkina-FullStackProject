...
const ProjectsList = () => {
  ...
  const handleDeleteProject = async (projectId) => {
    ...
    try {
      ...
      setError(err.message);
      // Show error as an alert to ensure user sees it
              ...
              >
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <Typography variant="body2" color="text.secondary">
                      <strong>Start:</strong> {dayjs(project.startDate).format('MMM D, YYYY')}
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      <strong>End:</strong> {dayjs(project.endDate).format('MMM D, YYYY')}
                    </Typography>
                  </Box>
                ...
                <CardActions sx={{ justifyContent: 'space-between', p: 1 }}>
                  ...
                  <Button
                    ...
                    onClick={() => handleManageTasks(project._id)}
                    sx={{ color: '#dd2825' }}
                  >
                    Manage Tasks
                  </Button>
